      ...
      $.ajax({
        ...
        success: function(data){
          ...
          $video.find('video').mediaelementplayer({
            pluginPath: '++resource++wildcard-media/mediaelementjs/',
...
$.extend(MediaElementPlayer.prototype, {
	buildgoogleanalytics: function(player, controls, layers, media) {
      ...
      console.log("play " + player.currentSrc);
			if (typeof _gaq != 'undefined') {
        console.log("_gaq play " + player.currentSrc);
      ...
      console.log("pause " + player.currentSrc);
			if (typeof _gaq != 'undefined') {
        console.log("_gaq pause " + player.currentSrc);
				_gaq.push(['_trackEvent',
					player.options.googleAnalyticsCategory,
      ...
      console.log("ended " + player.currentSrc);
			if (typeof _gaq != 'undefined') {
        console.log("_gaq ended " + player.currentSrc);
				_gaq.push(['_trackEvent',
					player.options.googleAnalyticsCategory,
