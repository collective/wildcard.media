...
audiooptional_behavior = getUtility(IBehavior, name='wildcard.media.behavior.IAudioOptional')

from wildcard.media.behavior import IAudioOptional
...
class AudioIntegrationTest(unittest.TestCase):
    ...
    def create(self, id):
        ...
        audiooptional_behavior(id, None)
    ...
    def test_factory(self):
        ...
        self.assertTrue(IAudioOptionalEnabled.providedBy(new_object))

    def test_adding(self):
        self.create('audio1')
        self.assertTrue(IAudioOptionalEnabled.providedBy(self.portal['audio1']))
