...
class AudioIntegrationTest(unittest.TestCase):
    ...
    def create(self, id):
        self.portal.invokeFactory("WildcardAudio", id, audio_file=getAudioBlob())
...
class AudioFunctionalTest(unittest.TestCase):
    ...
    def test_add_audio(self):
        ...
        file_ctl = self.browser.getControl(name="form.widgets.IAudio.audio_file")
        ...
        self.assertIn(
            "++widget++form.widgets.IAudio.audio_file/@@stream", self.browser.contents
        )
